...
if(login != null && login.equals("login")) {
	...
	if(un==null||un==""){
		out.println("用户名错误");
%>
		<br/><a href="../index2.jsp">返回首页</a>
		<br/><a href="userlogin.jsp">重新登录</a>
<% 
		return;
	}
	User u = null;
...
<FORM name=adminlogin action="userlogin.jsp" method="post">
...
<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0>
        ...
        <TR>
          <TD>
            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" 
              border=0><TBODY>
              <tr>
                 <TD align=middle width=81><FONT color=#ffffff></FONT><span id="err"></span></TD>
              </tr>
              <TR>
  ...
  <TR>
    ...
    <TD colSpan=2><A href="../index2.jsp"><IMG 
